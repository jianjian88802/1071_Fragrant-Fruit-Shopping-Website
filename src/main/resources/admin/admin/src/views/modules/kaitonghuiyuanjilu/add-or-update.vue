<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开通时间" prop="kaitongshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaitongshijian" 
                type="datetime"
                placeholder="开通时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaitongshijian" label="开通时间" prop="kaitongshijian">
              <el-input v-model="ruleForm.kaitongshijian" 
                placeholder="开通时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买天数" prop="goumaitianshu">
          <el-input v-model="ruleForm.goumaitianshu" 
              placeholder="购买天数" clearable  :readonly="ro.goumaitianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买天数" prop="goumaitianshu">
              <el-input v-model="ruleForm.goumaitianshu" 
                placeholder="购买天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开通费用" prop="kaitongfeiyong">
            <el-input v-model="kaitongfeiyong"
                placeholder="开通费用" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaitongfeiyong" label="开通费用" prop="kaitongfeiyong">
              <el-input v-model="ruleForm.kaitongfeiyong" 
                placeholder="开通费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  data() {
	...
	huiyuandengji : false,
	zhekou : false,
	kaitongshijian : false,
	goumaitianshu : false,
	jiage : false,
	kaitongfeiyong : false,
	zhanghao : false,
	xingming : false,
	sfsh : false,
	shhf : false,
  ...
  computed: {
    kaitongfeiyong:{
      get: function () {
        return 1*this.ruleForm.goumaitianshu*this.ruleForm.jiage
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhekou = true;
          ...
          if(o=='kaitongshijian'){
            this.ruleForm.kaitongshijian = obj[o];
	    this.ro.kaitongshijian = true;
            continue;
          }
          if(o=='goumaitianshu'){
            this.ruleForm.goumaitianshu = obj[o];
	    this.ro.goumaitianshu = true;
            continue;
          }
          if(o=='jiage'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='kaitongfeiyong'){
            this.ruleForm.kaitongfeiyong = obj[o];
	    this.ro.kaitongfeiyong = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    info(id) {
      this.$http({
        url: `kaitonghuiyuanjilu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.kaitongfeiyong = this.kaitongfeiyong
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kaitonghuiyuanjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaitonghuiyuanjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
