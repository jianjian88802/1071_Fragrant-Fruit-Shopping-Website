...
export default {
  ...
  computed: {
    zongjifen:{
      get: function () {
        return 1*this.ruleForm.shuliang*this.ruleForm.jifen
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jifenduihuanjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jifenduihuanjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
