  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">水果购物网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="会员等级" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuandengji" autocomplete="off" placeholder="会员等级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			...
			<el-form-item label="折扣" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.zhekou" autocomplete="off" placeholder="折扣"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`huiyuan` == this.tableName && this.ruleForm.zhekou&&(!this.$validate.isNumber(this.ruleForm.zhekou))){
        this.$message.error(`折扣应输入数字`);
        return
      }
      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210303/dd57b9f66c274891b5cc6f5d09201bb9.jpg");
		height: 100vh;
